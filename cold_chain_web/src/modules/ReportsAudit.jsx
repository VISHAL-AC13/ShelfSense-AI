...
export default function ReportsAudit({ shipments }) {
  ...
  const handleDownloadPDF = () => {
    ...
    doc.text("FSSAI & HACCP Quality Assurance Document // Audited by: System Admin", 14, 28);
    ...
    doc.text(`Generated by ShelfSense AI Client // Audited by System Admin // Timestamp: ${new Date().toISOString()}`, 14, pageHeight - 12);
